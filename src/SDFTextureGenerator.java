...
public class SDFTextureGenerator extends javax.swing.JFrame implements PropertyChangeListener {
	...
	public SDFTextureGenerator(String[] args) {
	...
	@SuppressWarnings("unchecked")
        ...
        private void initComponents() {
                ...
                gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
                jPanel1.add(openButton, gridBagConstraints);
                ...
                gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
                gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
                jPanel3.add(generateButton, gridBagConstraints);
                ...
                saveButton.setText("Save Texture");
                ...
                jLabel5.setText("Coded by: Joshua Lambert");
                gridBagConstraints = new java.awt.GridBagConstraints();
                gridBagConstraints.gridx = 0;
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(SDFTextureGenerator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				...
				SDFTextureGenerator window = new SDFTextureGenerator(args);
				window.pack();
